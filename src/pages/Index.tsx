...
import { FileText, Coins, ShieldCheck, Leaf, ArrowRight, CheckCircle2, AlertTriangle, TrendingUp, Users, Globe, Play } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-blue-50 to-white">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-tight">
                Fighting <span className="text-emerald-600">Food Fraud</span> in Africa
              </h1>
              
              <p className="text-xl sm:text-2xl font-body text-gray-600 leading-relaxed">
                Blockchain traceability + Artificial Intelligence to guarantee the authenticity of African agricultural products.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link to={DEMO_VERIFY_URL} className="w-full sm:w-auto">
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <Button size="lg" className="w-full bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-500 hover:to-violet-500 text-white font-bold text-lg px-8 py-6 shadow-lg hover:shadow-xl transition-all">
                ...
                <Link to="/register" className="w-full sm:w-auto">
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <Button size="lg" className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-lg px-8 py-6 shadow-lg hover:shadow-xl transition-shadow">
                      Get Started
                ...
                <Link to="/verify" className="w-full sm:w-auto">
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <Button size="lg" variant="outline" className="w-full border-2 border-gray-300 hover:border-emerald-600 font-bold text-lg px-8 py-6 hover:bg-emerald-50 transition-colors">
                      Verify Batch
                    </Button>
                  </motion.div>
                </Link>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6">Food Fraud Costs <span className="text-red-600">Billions</span></h2>
              <p className="text-lg sm:text-xl font-body text-gray-600 max-w-3xl mx-auto leading-relaxed">
                In Africa, food fraud threatens consumer trust and penalizes honest producers
              </p>
            </motion.div>
            
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-8">
              {[
                { stat: '40%', desc: 'of agricultural products are mislabeled or fraudulent', delay: 0.1 },
                { stat: '$40B', desc: 'lost annually due to global food fraud', delay: 0.2 },
                { stat: '0%', desc: 'transparency in traditional supply chains', delay: 0.3 }
              ].map((item, idx) => (
                <motion.div 
                  key={idx}
                  ...
                  whileHover={{ y: -5 }}
                >
                  <div className="text-5xl sm:text-6xl font-extrabold text-red-600 mb-4">{item.stat}</div>
                  <p className="font-body text-base text-gray-600 leading-relaxed">{item.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6">AgriTrust: <span className="text-emerald-600">Blockchain + AI</span></h2>
              <p className="text-lg sm:text-xl font-body text-gray-600 max-w-3xl mx-auto leading-relaxed">
                A complete platform combining Hedera Hashgraph and Gemini AI for total traceability
              </p>
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              {[
                ...
                },
                {
                  ...
                  desc: 'Automatic translation in French, English and African local languages for mass adoption',
                  delay: 0.4
                }
              ].map((item, idx) => {
                ...
                const colorClasses = {
                  ...
                  orange: { border: 'border-orange-100', bg: 'bg-orange-100', text: 'text-orange-600' }
                ...
                return (
                  <motion.div
                    ...
                    transition={{ delay: item.delay, duration: 0.5 }}
                  >
                    <Card className={`border-2 ${colorClasses.border} hover:shadow-xl transition-shadow h-full`}>
                      <CardHeader>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-6">How It <span className="text-emerald-600">Works</span></h2>
              <p className="text-lg sm:text-xl font-body text-gray-600 max-w-3xl mx-auto leading-relaxed">
                A simple 3-step process to guarantee the authenticity of your products
              </p>
            </motion.div>
                ...
                return (
                  ...
                  >
                    <div className="text-center space-y-4">
                      ...
                      <div className="text-6xl font-extrabold text-emerald-100">{feature.step}</div>
                      <h3 className="text-2xl font-bold text-gray-900">{feature.title}</h3>
                      <p className="font-body text-gray-600 leading-relaxed">{feature.desc}</p>
                    </div>
                    {idx < 2 && (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-6">Impact for <span className="text-emerald-600">Everyone</span></h2>
              <p className="text-lg sm:text-xl font-body text-gray-600 max-w-3xl mx-auto leading-relaxed">
                A solution that benefits all actors in the agricultural value chain
              </p>
            </motion.div>
              ...
              {[
                {
                  icon: Users,
                  title: 'Producers',
                  benefits: ['Protection against counterfeiting', 'Valorization of authentic products', 'Access to premium markets'],
                  color: 'emerald',
                  delay: 0.1
                },
                {
                  icon: ShieldCheck,
                  title: 'Consumers',
                  benefits: ['Authenticity guarantee', 'Complete traceability', 'Restored trust'],
                  color: 'blue',
                  delay: 0.2
                },
                {
                  icon: TrendingUp,
                  title: 'Distributors',
                  benefits: ['Risk reduction', 'ESG compliance', 'Market differentiation'],
                  color: 'purple',
                  delay: 0.3
                }
              ].map((stakeholder, idx) => {
                ...
                const colorClasses = {
                  emerald: { from: 'from-emerald-50', border: 'border-emerald-100', bg: 'bg-emerald-100', text: 'text-emerald-600' },
                  blue: { from: 'from-blue-50', border: 'border-blue-100', bg: 'bg-blue-100', text: 'text-blue-600' },
                  purple: { from: 'from-purple-50', border: 'border-purple-100', bg: 'bg-purple-100', text: 'text-purple-600' }
                ...
                return (
                  <motion.div
                    ...
                    whileHover={{ y: -5 }}
                  >
                    <div className={`inline-flex items-center justify-center w-16 h-16 ${colorClasses.bg} rounded-xl mb-6`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Link to="/login">
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Button size="lg" className="bg-white text-emerald-700 hover:bg-gray-100 font-bold text-lg px-10 py-6 shadow-2xl">
                    Get Started Now
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                </motion.div>
              ...
              <Link to="/verify">
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white/10 font-bold text-lg px-10 py-6">
                    Verify a Product
                  </Button>
                </motion.div>
              </Link>
